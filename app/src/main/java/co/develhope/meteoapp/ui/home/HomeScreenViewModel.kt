...
sealed class WeeklyResult() {
    data class Result(val list: List<WeatherSummary>, val place: Place, val date: OffsetDateTime) : WeeklyResult()
}
...
class HomeScreenViewModel : ViewModel() {
    ...
    val weeklyWeatherData : MutableLiveData<WeeklyResult> = _weeklyWeatherData
    ...
    fun getWeeklyWeather(){
        viewModelScope.launch {
            try{
                ...
                val weeklyForecast = NetworkProvider().getWeeklySummary(place.latitude,place.longitude)
